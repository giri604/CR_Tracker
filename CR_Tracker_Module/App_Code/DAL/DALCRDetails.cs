...
namespace CR_Tracker_Module.DAL
{
    public class CRDetails
    {
        ...
        #region "ADDCRDetail"
        public string ADDCRDetail(CR_Tracker_Module.Models.CRDetails cRDetails, HttpPostedFileBase attachFile)
        {
            try
            {
        ...
        #region "GetCRDetail"
        public CR_Tracker_Module.Models.CRDetails GetCRDetail(int crId)
        {
            CR_Tracker_Module.Models.CRDetails cRDetail = new Models.CRDetails();
            try
            {
